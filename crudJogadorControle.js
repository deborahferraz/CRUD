...
function procure() {
    ...
    if (Id) { // se digitou um CodigoReserva
...
function alterar() {
    ...
    document.getElementById("outputCategoria").value = "";
}
...
function salvar() {
    ...
    const dataAtual = document.getElementById("inputAtual").value;
    //verificar se o que foi digitado pelo USUÁRIO está correto
    if (Id && nome && dataNascimento && dataAtual) {// se tudo certo 
        switch (oQueEstaFazendo) {
            case 'inserindo':
                jogador = new Jogador(Id, nome, dataNascimento, dataAtual);
                listaJogador.push(jogador);
                mostrarAviso("Inserido na lista");
                break;
            case 'alterando':
                jogadorAlterado = new Jogador(Id, nome, dataNascimento, dataAtual);
...
function mostrarDadosJogador(jogador) {
    ...
    document.getElementById("inputData").value = jogador.dataNascimento;
...
function limparAtributos() {
    ...
    document.getElementById("inputAtual").value = "";
...
function bloquearAtributos(soLeitura) {
    ...
    document.getElementById("inputAtual").readOnly = soLeitura;
}
